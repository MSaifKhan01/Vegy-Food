...
import UserDetailSlice from "../utills/UserSlice"
...
function Login() {
    ...
    const SetUserData = (e) => {
        ...
        console.log("form data :---", { ...loginUserData, [name]: value }); // Use updated value directly
    }
    ...
    const handleLogin = async (e) => {
        e.preventDefault();
        try {
            const action = await dispatch(SignIn(loginUserData)); // Dispatch SignIn action with loginUserData
        ...
        <div className="flex justify-center items-center mt-10">
            <div>
                <form className="flex flex-col items-center">
                    <input type="text"  placeholder="Your Email" name="email" onChange={SetUserData} className="border border-gray-400 rounded-lg px-4 py-2 mb-4" />
                    <input type="password" placeholder="Your Password" name="password" onChange={SetUserData} className="border border-gray-400 rounded-lg px-4 py-2 mb-4" />
